...
bot.onText(/\/start/, msg => {
    ...
    bot.sendMessage(chatId, `${msg.from.first_name} Assalomu alaykum bizning restarant botimizga hush kelibsiz! `, {
        reply_markup: {
...
bot.on("callback_query", async msg => {
    ...
    if (orderName  ) {
        return await askLocation(bot, chatId, orderName,)
    }
})
...
bot.on('location', async msg => {
    ...
    if (userLocation) {
        return getLocation( bot, chatId, userLocation)
    }
})
